...
import org.jsystem.webdriver_so.WebDriverContainer;
 ...
 * 
 * copy to SUT :
 * org.jsystem.webdriver_so.eventlistener.WebDriverScreenshotEventHandler
 * 
...
public class WebDriverScreenshotEventHandler implements WebDriverEventListener, TestListener, WebDriverContainer {
	...
	private final Reporter reporter = ListenerstManager.getInstance();
